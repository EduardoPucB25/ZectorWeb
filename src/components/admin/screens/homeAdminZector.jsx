...
//         onClick = onClick.bind(state);
//         onHide = onHide.bind(state);
//     }
...
//       return (
//         <div>
//             <Button label="Cancelar" icon="pi pi-times" onClick={() => onHide(name)} className="p-button-warning" />
//             <Button label="Enviar" icon="pi pi-check" onClick={() => onHide(name)} autoFocus className='p-button-success' />
//         </div>
//       );
//     }
...
//       <Button label="Agregar " icon="pi pi-plus" className="p-mr-2" onClick={() => onClick('displayTablePersonal')} />

//       <Dialog header="Agregar Personal" visible={state.displayTablePersonal} style={{ height: 1000, width: 600 }} footer={renderFooter('displayTablePersonal')} onHide={() => onHide('displayTablePersonal')}>
...
function Categoria(props) {
  ...
  return (
    <>
      <Box >
        <Button label={categoria.nombre} icon='pi pi-users' rounded text severity="info" aria-label="User" />
...
const modulePersonal = [
  createPersonal('Doctores', rowsMedicos, '1V51A561FV65A6',),
  createPersonal('Enfermeras', rowsCirujanos, 'ADF54A65DFB'),
...
export default class HomeAdminZector extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      displayTableDoctores: false,
      displayTableEnfermeras: false,
      displayTableAdministrativos: false,
                      ...
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell align="left">
                            ...
                            <div style={{ alignItems: 'center' }}>
                              <Button label={"Agregar " + table.nombre} icon="pi pi-plus" className="p-mr-2" onClick={() => this.onClick(`displayAgregar${table.nombre}`)} />

                              <Dialog header={"Agregar " + table.nombre} visible={this.state.displayTableAdministrativos} style={{ height: 1000, width: 600 }} footer={this.renderFooter('displayAgregarMedicos')} onHide={() => this.onHide('displayAgregarMedicos')}>
                                {/* AQUI INICIA EL FORMULARIO */}
                                <GridFormPersonal />

                              </Dialog>
                              <Dialog header={"Agregar " + table.nombre} visible={this.state.displayTableEnfermeras} style={{ height: 1000, width: 600 }} footer={this.renderFooter('displayAgregarCirujanos')} onHide={() => this.onHide('displayAgregarCirujanos')}>
                                {/* AQUI INICIA EL FORMULARIO */}
                                <GridFormPersonal />
